...
if(isset($_POST['send'])){
   ...
   if(mysqli_num_rows($select_message) > 0){
      ...
      $message[] = 'Tin nhắn đã được gửi đi!';
   }
...
<section class="contact">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="number" required placeholder="Số điện thoại" class="box">
      <textarea name="message" class="box" placeholder="Lời nhắn của bạn" id="" cols="30" rows="10"></textarea>
